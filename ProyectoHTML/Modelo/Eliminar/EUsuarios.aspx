<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EUsuarios.aspx.cs" Inherits="ProyectoHTML.Modelo.Eliminar.EUsuarios" %>
                ...
                <div class="GridsRegistros">
                    ...
                    <div class="thirdgrid">
                        ...
                        <div class="sgrid">
                            ...
                            <asp:GridView ID="GridView4" runat="server" CssClass="datagrid">
                            </asp:GridView>
                        </div>
                    </div>
                </div>
