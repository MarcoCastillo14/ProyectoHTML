<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PTecnicos.aspx.cs" Inherits="ProyectoHTML.Modelo.Principales.PrincipalTecnicos" %>
...
<body>
    <form id="form1" runat="server">
        <div class="Principal">
            ...
            <div class="top">
                <a href="../Agregar/ATecnicos.aspx" class="TopLink">Agregar</a>
                <a href="../Modificar/MTecnicos.aspx" class="TopLink">Modificar</a>
                <a href="../Eliminar/ETecnicos.aspx" class="TopLink">Eliminar</a>
            </div>
            <div class="Grid">
                <div class="input-group">
                    <label class="input-label">Buscar </label>
                    <asp:TextBox AutoPostBack="true" ID="Buscar" runat="server" CssClass="textbox" placeholder="Nombre" OnTextChanged="Buscar_TextChanged"></asp:TextBox>
                </div>
