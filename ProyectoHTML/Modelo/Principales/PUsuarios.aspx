<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PUsuarios.aspx.cs" Inherits="ProyectoHTML.Modelo.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        <div class="Principal">
            ...
            <div class="top">
                <a href="../Agregar/AUsuarios.aspx" class="TopLink">Agregar</a>
                <a href="../Modificar/MUsuarios.aspx" class="TopLink">Modificar</a>
                <a href="../Eliminar/EUsuarios.aspx" class="TopLink">Eliminar</a>
            </div>
            <div class="Grid">
                <div class="input-group">
                    <label class="input-label">Buscar </label>
                    <asp:TextBox  AutoPostBack="true" ID="Buscar" runat="server" CssClass="textbox" placeholder="Nombre" MaxLength="50" OnTextChanged="Buscar_TextChanged"></asp:TextBox>
                </div>
