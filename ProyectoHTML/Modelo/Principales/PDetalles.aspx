<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PDetalles.aspx.cs" Inherits="ProyectoHTML.Modelo.Principales.PDetalles" %>
...
<body>
    <form id="form1" runat="server">
        <div class="Principal">
            ...
            <div class="top">
                <a href="../Agregar/ADetalles.aspx" class="TopLink">Agregar</a>
                <a href="../Modificar/MDetalles.aspx"" class="TopLink">Modificar</a>
                <a href="../Eliminar/EDetalles.aspx" class="TopLink">Eliminar</a>
            </div>
            <div class="Grid">
