<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PEquipos.aspx.cs" Inherits="ProyectoHTML.Modelo.Principales.PEquipos" %>
...
<body>
    <form id="form1" runat="server">
        <div class="Principal">
            ...
            <div class="top">
                <a href="../Agregar/AEquipos.aspx" class="TopLink">Agregar</a>
                <a href="../Modificar/MEquipos.aspx" class="TopLink">Modificar</a>
                <a href="../Eliminar/EEquipos.aspx" class="TopLink">Eliminar</a>
            </div>
            <div class="Grid">
                <div class="input-group">
                    <label class="input-label">Buscar </label>
                    <asp:TextBox type="Number" AutoPostBack="true" ID="Buscar" runat="server" CssClass="textbox" placeholder="UserID" OnTextChanged="Buscar_TextChanged"></asp:TextBox>
                </div>
