<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MAsignaciones.aspx.cs" Inherits="ProyectoHTML.Modelo.Modificar.MAsignaciones" %>
        ...
        <div class="Principal">
            ...
            <div class="Grid">
                ...
                <div class="input-group">
                    ...
                    <asp:TextBox type="Number" AutoPostBack="true" ID="Buscar" required="" runat="server" CssClass="textbox" placeholder="AsignacionID" OnTextChanged="Buscar_TextChanged"></asp:TextBox>
                </div>
                <div class="form-container">
                    ...
                    <div class="input-group">
                        ...
                        <asp:DropDownList ID="Tecnico" runat="server" CssClass="textbox" OnSelectedIndexChanged="Equipo_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
                    <div class="input-group">
