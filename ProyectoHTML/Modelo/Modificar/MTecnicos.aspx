<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MTecnicos.aspx.cs" Inherits="ProyectoHTML.Modelo.Modificar.MTecnicos" %>
        ...
        <div class="Principal">
            ...
            <div class="Grid">
                ...
                <div class="input-group">
                    ...
                    <asp:TextBox type="Number" AutoPostBack="true" ID="Buscar" required="" runat="server" CssClass="textbox" placeholder="TecnicoID" OnTextChanged="Buscar_TextChanged"></asp:TextBox>
                </div>
