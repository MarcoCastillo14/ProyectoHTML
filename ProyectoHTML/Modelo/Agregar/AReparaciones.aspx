<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AReparaciones.aspx.cs" Inherits="ProyectoHTML.Modelo.Agregar.AReparaciones" %>
            ...
            <div class="Grid">
                ...
                <div class="form-container">
                    <div class="input-group">
                        ...
                        <asp:DropDownList ID="Equipo" runat="server" CssClass="textbox" required="" OnSelectedIndexChanged="Equipo_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
                    <div class="input-group">
                    ...
                    <div class="input-group">
                        ...
                        <asp:DropDownList ID="Estado" runat="server" CssClass="textbox" required="" OnSelectedIndexChanged="Unnamed2_SelectedIndexChanged">
                            <asp:ListItem Text="" />
                ...
                <div class="secondgrid">
                    <div class="sgrid">
                        <h3 class="grid-heading">Equipos</h3>
